...
public class Utils {
    ...
    public static void bookmarkUrl(Context context, String url,String title) {
        SharedPreferences pref = context.getSharedPreferences("bookmark", 0); // 0 - for private mode
    ...
    public static boolean isBookmarked(Context context, String url) {
        SharedPreferences pref = context.getSharedPreferences("bookmark", 0);
        /*return pref.getBoolean(url, false);*/
        return pref.contains(url);
    }
}
